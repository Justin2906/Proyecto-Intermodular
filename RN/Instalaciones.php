<?php
    ...
    $consultaSQL = "SELECT id, Nombre, Dimensiones, Foto from Instalaciones where Tipo = 'Deportes';";
            ...
            <div class="polis">
                ...
                <div class="services">
                    ...
                    <div class="info2">
                        ...
                        <h4>📍<?php print_r($registro['Dimensiones']); ?></h4>
                        <img src="Fotos BBDD/<?php echo ($registro['Foto']) ?>" alt=""><br>
                        <a class="btn btn-primary" href="Reservas.php?idInstalacion=<?php echo($registro['id']) ?>&idLugar=<?php echo($idLugar) ?>">Reservar</a><br>
                    </div>&nbsp;&nbsp;&nbsp;
