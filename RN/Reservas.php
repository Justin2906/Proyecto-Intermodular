...
$consultaSQL2 = "SELECT Nombre from Instalaciones where id = $idInstalacion;";
...
if (isset($_POST['submit'])) {
  ...
  if ($estado) {
    $consultaSQL = "INSERT INTO Reservas (id_cliente, Fecha, Hora, id_lugares, id_instalaciones) values ($idCliente, '$fecha', '$hora', $idLugar, $idInstalacion);";
